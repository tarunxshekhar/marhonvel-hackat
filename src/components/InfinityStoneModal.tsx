...
export const InfinityStoneModal: React.FC<InfinityStoneModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="fixed top-6 right-6 z-60 w-12 h-12 bg-black/80 hover:bg-black/90 rounded-full flex items-center justify-center transition-colors duration-200 group border border-gray-600 hover:border-gray-400"
      >
